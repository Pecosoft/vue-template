<template lang="pug">
  btn.peco-btn_primary(:class='{"peco-btn_loading": thisLoading, "peco-btn_plain-primary": plain, "peco-btn_disabled": thisDisable, "peco-btn_plain-disabled": plain && thisDisable }')
...
.peco-btn_primary {
  ...
  &:not(.peco-btn_disabled):visited {
    color: #FFFFFF;
  }
  &:not(.peco-btn_disabled):active {
    color: rgba(255,255,255,.6);
    background-color: #179B16;
  }
}

.peco-btn_plain-primary {
  color: rgba(26,173,25,1);
  border: 1px solid rgba(26,173,25,1);
  &:not(.peco-btn_plain-disabled):active {
