...
page
  ...
  create(@oncreated='handleOnCreated' v-if='cate==1' title='新增产品投诉' btn-text='提交投诉' resource-name='complain' :model='complain1' store-module='complain' form-name='productForm')
  create(@oncreated='handleOnCreated' v-else title='新增服务投诉' btn-text='提交投诉' resource-name='complain' :model='complain' store-module='complain' form-name='serviceForm')
</template>
